                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                @php
                                    // ইউজারের বর্তমান রোল আইডি খুঁজে বের করা
                                    $currentRoleId = $user->roles->isNotEmpty() ? $user->roles->first()->id : null;
                                    // বর্তমান Depo বা Distributor ডেটা
                        ...
                        <div id="dynamic-fields">
                            ...
                            <div class="row depo-fields dynamic-field" style="display: none;">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" 
                                        value="{{ old('location', $currentDepo ? $currentDepo->location : '') }}">
                            ...
                            <div class="row distributor-fields dynamic-field" style="display: none;">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" 
                                        value="{{ old('location', $currentDistributor ? $currentDistributor->location : '') }}">
                                    @error('location')<span class="invalid-feedback">{{ $message }}</span>@enderror
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status_inactive" value="inactive" {{ old('status', $user->status) == 'inactive' ? 'checked' : '' }}>
