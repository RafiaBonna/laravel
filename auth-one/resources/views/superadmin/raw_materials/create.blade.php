            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('superadmin.raw_materials.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="alert_stock" class="form-control @error('alert_stock') is-invalid @enderror" value="{{ old('alert_stock', 0) }}" required>
