        ...
        <div class="container-fluid">
            ...
            <div class="card">
                        ...
                        <tbody>
                            @forelse($depos as $user)
                                <tr>
                                    ...
                                    <td>
                                        {{-- ✅ Edit এবং Delete-এর জন্য User Management-এর Route ব্যবহার করুন --}}
                                        ...
                                        <form action="{{ route('superadmin.users.destroy', $user->id) }}" method="POST" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this user and associated Depo? This action is irreversible.')">
                ...
                <div class="card-footer clearfix">
                    {{ $depos->links('vendor.pagination.bootstrap-4') }}
                </div>
            </div>
        </div>
    </section>
